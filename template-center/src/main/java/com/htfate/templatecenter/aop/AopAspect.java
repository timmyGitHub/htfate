package com.htfate.templatecenter.aop;

import com.google.common.collect.Lists;
import com.htfate.templatecenter.config.bean.AuthenticationInfo;
import com.htfate.templatecenter.config.bean.IAuthenticationInfo;
...
public class AopAspect {
    ...
    @Pointcut("execution(public * com.htfate.templatecenter.*.controller.*.*(..))")
